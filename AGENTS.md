# Agent instructions (canvas-chat-2)
...
- **CLI**: **Typer** — entrypoint wired in `pyproject.toml` under `[project.scripts]`; implementation lives under `canvas_chat_2/`.
...
- **Package code**: `canvas_chat_2/` — main library and CLI.
